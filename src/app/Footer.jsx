...
export default function Footer() {
  return (
    <footer className="flex flex-col justify-between text-white">
      ...
      />
      <div className="container flex gap-20 pl-40 mx-auto py-28">
        <div className="flex flex-col gap-5 w-72">
          ...
          <div className="flex gap-2">
            <button className="flex items-center justify-center w-12 h-12 p-2 bg-gray-800">
              <Image
        ...
        <div className="flex flex-col gap-4 w-72">
          ...
          <div className="">
            <h3 className="text-lg font-bold font-display">Office Location</h3>
            <div className="flex gap-2">
              <Image
